...
Proyecto: SignalAI — bot de Telegram que analiza charts de TradingView con
...
'SignalAI convierte cualquier gráfico de TradingView en un trade
...
```
"Diseña la arquitectura de SignalAI: FastAPI + Telegram + Claude Haiku +
...
```markdown
# SignalAI — contexto para Claude Code
