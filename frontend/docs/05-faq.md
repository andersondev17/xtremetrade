...
5. Nombre visible del bot: `Xtreme Trade`
...
1. En claude.ai, abrir el proyecto Xtreme Trade
...
> "Xtreme Trade convierte cualquier gráfico de TradingView en un trade ejecutado on-chain en 3 segundos."
 
Memorizarlo. Usarlo al inicio y al final del pitch.
 
### ¿Qué diferencia a Xtreme Trade de KiSignal (ganador anterior)?
 
KiSignal analiza texto. Xtreme Trade analiza **imágenes de charts** con visión multimodal. Ningún competidor en la sala hace análisis de imagen — ese es el diferenciador técnico real que los jueces reconocerán.